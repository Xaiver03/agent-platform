...
console.log('🚀 创建简化版零依赖exe...')

// 使用更简单的方法 - 打包现有Next.js应用
const buildScript = `
#!/bin/bash
# 简化版本 - 使用Next.js构建
...
fs.writeFileSync('build-simple-exe.sh', buildScript)
fs.writeFileSync('build-simple-exe.bat', buildScript.replace('#!/bin/bash', '@echo off').replace(/echo/g, 'echo'))

console.log('🎉 简化构建脚本已创建！')
console.log('')
console.log('📋 使用方法：')
console.log('1. macOS/Linux: ./build-simple-exe.sh')
console.log('2. Windows: ./build-simple-exe.bat')
console.log('3. 得到: dist-exe/AI-Agent-体验台.exe')
console.log('4. 使用: 双击即可运行！')